    ...
    companion object {
        ...
        fun toCampaignResponse(entryRecord: EntryRecord) = CampaignResponse(
            billboard = BillboardResponse(
                ...
                price = 0.0,
                imageId = entryRecord.billboardData?.imageId,
        ...
        fun fromBillboardResponse(billboardResponse: BillboardResponse) = EntryRecord(
            ...
            billboardData = BillboardDataEntity(
                ...
                parentBoardCode = billboardResponse.parentBoardCode,
                boardCode = billboardResponse.boardCode,
                remoteFileName = billboardResponse.image?.fileName,
                remoteCloseUpFileName = billboardResponse.closeupImage?.fileName
            )
        )
        ...
        fun fromCampaignResponse(campaignResponse: CampaignResponse) = EntryRecord(
            ...
            billboardData = BillboardDataEntity(
                ...
                boardCode = campaignResponse.billboard?.boardCode,
                remoteFileName = campaignResponse.billboard?.image?.fileName,
                remoteCloseUpFileName = campaignResponse.billboard?.closeupImage?.fileName
            )
        )
