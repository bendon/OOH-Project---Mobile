        ...
        topBar = {
            ...
            Column(
                ...
                Column(
                    ...
                    Text(text = "Full image", fontSize = 18.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top = 16.dp))
                    ...
                    Text(text = "Billboard image", fontSize = 18.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top = 16.dp))
                    ...
                    Text(text = "Campaign information", fontSize = 18.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top = 16.dp))
                    OutlinedTextField(
                    ...
                    Text(text = "Billboard information", fontSize = 18.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top = 16.dp))
                    OutlinedTextField(
                        modifier = Modifier.padding(vertical = 8.dp).fillMaxWidth(),
                        value = billboardType,
                    ...
                    if (!currentData?.qrCode.isNullOrEmpty()){
                        Text(text = "QR code", fontSize = 18.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top = 16.dp))
                    ...
                    if (!currentData?.entityInfos.isNullOrEmpty()){
                        ...
                        currentData?.entityInfos?.forEach {
                            Text(text = "${it.type}: ${it.text}", modifier = Modifier.padding(vertical = 6.dp))
                        }
                    }

                    Text(text = "Billboard location", fontSize = 18.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top = 16.dp))
